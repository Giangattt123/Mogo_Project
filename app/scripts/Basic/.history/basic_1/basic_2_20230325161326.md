...
Vì vậy, khi bạn chạy đoạn mã trên, hàm sẽ xuất ra undefined trong console, bởi vì biến x đã được khai báo nhưng chưa được gán giá trị. Tuy nhiên, hoisting chỉ áp dụng cho khai báo biến và hàm, không áp dụng cho khai báo các hằng số const.
